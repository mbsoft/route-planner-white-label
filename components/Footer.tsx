...
const companyLogo = process.env.COMPANY_LOGO || '/company_logo.svg'


export default function Footer() {
  console.log('COMMIT:', process.env.NEXT_PUBLIC_GIT_COMMIT, 'VERSION:', process.env.NEXT_PUBLIC_VERSION)
  return (
    <footer style={{
      width: '100%',
      padding: '12px 0',
      ...
      <img src={companyLogo} alt="Company Logo" style={{ height: 48, marginRight: 8, verticalAlign: 'middle' }} />

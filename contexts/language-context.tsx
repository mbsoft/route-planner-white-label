...
const enTranslations = {
  ...
  "routePlanning": {
    ...
    "routePlanningWorkflow": "Route Planning Workflow",
    ...
    "configureOptimizationSettings": "Configure optimization settings",
    "importAndMapJobData": "Import and map job data",
    "importAndMapShipmentData": "Import and map shipment data",
    "importAndMapVehicleData": "Import and map vehicle data",
    "reviewDataAndStartOptimization": "Review data and start optimization",
    "saveMappingsTitle": "Save Mappings",
    "saveMappingsDescription": "Save current mapping configurations?",
          "saveMappingsDetails": "This will save the current Jobs Map, Vehicles Map, and Shipments Map configurations to persistent storage. This will overwrite any previously saved mappings.",
    "clearPreferencesTitle": "Clear Preferences",
    "clearPreferencesDescription": "Are you sure?",
    "clearPreferencesDetails": "This will permanently delete all saved optimization preferences from your browser's local storage. This action cannot be undone.",
    "cancel": "Cancel"
  },
  "sidebar": {
  ...
  "dataImport": {
    ...
    "importShipmentsFromDatabase": "Import Shipments from Database",
  ...
  "preferences": {
    ...
    "bikeMode": "Bike Mode",
    "footMode": "Foot Mode",
    "setYourObjective": "Set Your Objective",
    "travelCost": "Travel Cost",
    "customOptimizationCriteria": "Custom Optimization Criteria",
    "type": "Type",
    "value": "Value",
    "specifyConstraints": "Specify Constraints",
    "maxOvertimeAllowed": "Max overtime allowed",
    ...
    "truckSizePlaceholder": "height,width,length",
...
const esMxTranslations = {
  ...
  "routePlanning": {
    ...
    "routePlanningWorkflow": "Flujo de Planificación de Rutas",
    ...
    "configureOptimizationSettings": "Configurar ajustes de optimización",
    "importAndMapJobData": "Importar y mapear datos de trabajos",
    "importAndMapShipmentData": "Importar y mapear datos de envíos",
    "importAndMapVehicleData": "Importar y mapear datos de vehículos",
    "reviewDataAndStartOptimization": "Revisar datos e iniciar optimización",
    "saveMappingsTitle": "Guardar Mapeos",
    "saveMappingsDescription": "¿Guardar configuraciones de mapeo actuales?",
      "saveMappingsDetails": "Esto guardará las configuraciones actuales del Mapa de Trabajos, Mapa de Vehículos y Mapa de Envíos en el almacenamiento persistente. Esto sobrescribirá cualquier mapeo guardado anteriormente.",
    "clearPreferencesTitle": "Limpiar Preferencias",
    "clearPreferencesDescription": "¿Está seguro?",
    "clearPreferencesDetails": "Esto eliminará permanentemente todas las preferencias de optimización guardadas del almacenamiento local de su navegador. Esta acción no se puede deshacer.",
    "cancel": "Cancelar"
  },
  "sidebar": {
  ...
  "dataImport": {
    ...
    "importShipmentsFromDatabase": "Importar Envíos desde Base de Datos",
  ...
  "preferences": {
    ...
    "setYourObjective": "Establecer Tu Objetivo",
    "travelCost": "Costo de Viaje",
    "customOptimizationCriteria": "Criterios de Optimización Personalizados",
    "type": "Tipo",
    "value": "Valor",
    "specifyConstraints": "Especificar Restricciones",
    "maxOvertimeAllowed": "Tiempo extra máximo permitido",
    ...
    "truck": "Camión",
    "car": "Auto",
    "trafficTimestamp": "Marca de tiempo de tráfico",
    "truckSize": "Tamaño del camión",
    "truckSizePlaceholder": "altura,ancho,largo",
...
const ptBrTranslations = {
  ...
  "routePlanning": {
    ...
    "routePlanningWorkflow": "Fluxo de Planejamento de Rotas",
    ...
    "configureOptimizationSettings": "Configurar ajustes de otimização",
    "importAndMapJobData": "Importar e mapear dados de trabalhos",
    "importAndMapShipmentData": "Importar e mapear dados de envios",
    "importAndMapVehicleData": "Importar e mapear dados de veículos",
    "reviewDataAndStartOptimization": "Revisar dados e iniciar otimização",
    "saveMappingsTitle": "Salvar Mapeamentos",
    "saveMappingsDescription": "Salvar configurações de mapeamento atuais?",
    "saveMappingsDetails": "Isso salvará as configurações atuais do Mapa de Trabalhos, Mapa de Veículos e Mapa de Envios no armazenamento persistente. Isso sobrescreverá qualquer mapeamento salvo anteriormente.",
    "clearPreferencesTitle": "Limpar Preferências",
    "clearPreferencesDescription": "Tem certeza?",
    "clearPreferencesDetails": "Isso excluirá permanentemente todas as preferências de otimização salvas do armazenamento local do seu navegador. Esta ação não pode ser desfeita.",
    "cancel": "Cancelar"
  },
  "sidebar": {
  ...
  "dataImport": {
    ...
    "importShipmentsFromDatabase": "Importar Envios do Banco de Dados",
  ...
  "preferences": {
    ...
    "setYourObjective": "Definir Seu Objetivo",
    "travelCost": "Custo de Viagem",
    "customOptimizationCriteria": "Critérios de Otimização Personalizados",
    "type": "Tipo",
    "value": "Valor",
    "specifyConstraints": "Especificar Restrições",
    "maxOvertimeAllowed": "Tempo extra máximo permitido",
    ...
    "truck": "Caminhão",
    "car": "Carro",
    "trafficTimestamp": "Marca de tempo de tráfego",
    "truckSize": "Tamanho do caminhão",
    "truckSizePlaceholder": "altura,largura,comprimento",
...
const caFrTranslations = {
  ...
  "routePlanning": {
    ...
    "routePlanningWorkflow": "Flux de Planification d'Itinéraires",
    "stepOf": "Étape {current} sur {total} :",
    "workflowProgress": "Progrès du Flux :",
    "preferences": "Préférences",
    "jobs": "Tâches",
    "vehicles": "Véhicules",
    "reviewAndRun": "Réviser et Exécuter",
    "configureOptimizationSettings": "Configurer les paramètres d'optimisation",
    "importAndMapJobData": "Importer et mapper les données de tâches",
    "importAndMapShipmentData": "Importer et mapper les données d'expédition",
    "importAndMapVehicleData": "Importer et mapper les données de véhicules",
    "reviewDataAndStartOptimization": "Réviser les données et démarrer l'optimisation",
    "saveMappingsTitle": "Enregistrer les Mappages",
    "saveMappingsDescription": "Enregistrer les configurations de mappage actuelles ?",
    "saveMappingsDetails": "Cela enregistrera les configurations actuelles de la Carte des Tâches, de la Carte des Véhicules et de la Carte des Expéditions dans le stockage persistant. Cela remplacera tout mappage enregistré précédemment.",
    "clearPreferencesTitle": "Effacer les Préférences",
    "clearPreferencesDescription": "Êtes-vous sûr ?",
    "clearPreferencesDetails": "Cela supprimera définitivement toutes les préférences d'optimisation enregistrées du stockage local de votre navigateur. Cette action ne peut pas être annulée.",
    "cancel": "Annuler"
  },
  "sidebar": {
  ...
  "dataImport": {
    ...
    "importShipmentsFromDatabase": "Importer les Expéditions de la Base de Données",
  ...
  "preferences": {
    ...
    "setYourObjective": "Définir Votre Objectif",
    "travelCost": "Coût de Voyage",
    "customOptimizationCriteria": "Critères d'Optimisation Personnalisés",
    "type": "Type",
    "value": "Valeur",
    "specifyConstraints": "Spécifier les Contraintes",
    "maxOvertimeAllowed": "Temps supplémentaire maximum autorisé",
    ...
    "truck": "Camion",
    "car": "Voiture",
    "trafficTimestamp": "Horodatage du trafic",
    "truckSize": "Taille du camion",
    "truckSizePlaceholder": "hauteur,largeur,longueur",
